...
The source dataset is licensed under CC BY-NC-SA 4.0. ScentAI 32K is distributed under the same
license as a derivative dataset. Changes include normalization into text evidence cards, synthetic
query generation, deterministic selection and validation, curriculum labeling, seeded shuffling,
